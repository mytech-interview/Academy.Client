...
export const mockTeachers: User[] = [
  {
    ...
    name: 'სოსო ბერიძე',
    role: 'teacher',
    avatar: 'https://academy.tech-interview.com/images/beridze.jpg',
    headline: 'მონაცემთა ბაზებისა და პროგრამული დეველოპმენტის გამოცდილი სპეციალისტი',
    bio: 'სპეციალისტი 25-წლიანი გამოცდილებით.',
    createdAt: new Date().toISOString(),
  },
  {
    id: 'teacher-2',
    email: 'L.dolidze11@gmail.com',
    name: 'ლევან დოლიძე',
    role: 'teacher',
    avatar: 'https://academy.tech-interview.com/images/angular_teacher1.jpeg',
    headline: 'გამოცდილი Front-End დეველოპერი და მენტორი, მრავალწლიანი გამოცდილებით fintech სექტორში',
    bio: 'Front-End დეველოპმენტი და მენტორობა.',
    createdAt: new Date().toISOString(),
  },
  {
    id: 'teacher-3',
    email: 'ganja@ganja.com',
    name: 'ალექსი განჯა',
    role: 'teacher',
    avatar: 'https://academy.tech-interview.com/images/qa_teacher1.jpeg',
    headline: 'პროგრამული უზრუნველყოფის ტესტირების გამოცდილი სპეციალისტი',
    bio: 'ტესტირება, ავტომატიზაცია და ხარისხის კონტროლი.,',
    createdAt: new Date().toISOString(),
  },
];
